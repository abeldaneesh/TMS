...
import { ArrowLeft, Mail, Phone, MapPin, Shield, Calendar, CheckCircle2, XCircle, Clock, Briefcase, Building2 } from 'lucide-react';
...
const UserDetails: React.FC = () => {
    ...
    const institutionName = user.institution?.name || 'Not assigned';
    const operationalRank = user.designation || 'Not provided';
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 pt-6 border-t border-border/50 mt-6">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium">{operationalRank}</p>
                            </div>
                        </div>
