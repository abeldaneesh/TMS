    ...
    switch (user.role) {
      case 'master_admin':
        return [
          ...
          { icon: Users, label: t('nav.programOfficers', 'Program Officers'), path: '/program-officers' },
          { icon: UserCheck, label: t('nav.medicalOfficers', 'Medical Officers'), path: '/medical-officers' },
