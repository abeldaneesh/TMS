...
CREATE TABLE `Training` (
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `Training_hallId_fkey` FOREIGN KEY (`hallId`) REFERENCES `Hall`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT `Training_createdById_fkey` FOREIGN KEY (`createdById`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Nomination` (
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `Nomination_trainingId_fkey` FOREIGN KEY (`trainingId`) REFERENCES `Training`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT `Nomination_participantId_fkey` FOREIGN KEY (`participantId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT `Nomination_institutionId_fkey` FOREIGN KEY (`institutionId`) REFERENCES `Institution`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- 2. Users (Note: isApproved set to TRUE for seeded users)
INSERT INTO User (id, name, email, password, role, institutionId, designation, phone, department, createdAt, isApproved) VALUES
('user-1', 'Dr. Admin Kumar', 'admin@dmo.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'master_admin', NULL, 'DMO Administrator', '+91-9876543210', NULL, NOW(), TRUE),
('user-2', 'Dr. Priya Sharma', 'priya@dmo.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'program_officer', NULL, 'Senior Program Officer', '+91-9876543211', NULL, NOW(), TRUE),
('user-3', 'Dr. Rajesh Verma', 'rajesh@dmo.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'program_officer', NULL, 'Program Officer', '+91-9876543212', NULL, NOW(), TRUE),
('user-4', 'Dr. Anjali Patel', 'anjali@hospital1.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'institutional_admin', 'inst-1', 'Medical Superintendent', '+91-9876543213', NULL, NOW(), TRUE),
('user-5', 'Dr. Suresh Reddy', 'suresh@hospital2.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'institutional_admin', 'inst-2', 'Hospital Administrator', '+91-9876543214', NULL, NOW(), TRUE),
('user-6', 'Nurse Kavita Singh', 'kavita@hospital1.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'participant', 'inst-1', 'Staff Nurse', '+91-9876543215', 'General Ward', NOW(), TRUE),
('user-7', 'Dr. Amit Desai', 'amit@hospital1.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'participant', 'inst-1', 'Medical Officer', '+91-9876543216', 'Emergency', NOW(), TRUE),
('user-8', 'Pharmacist Meera Nair', 'meera@hospital2.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'participant', 'inst-2', 'Pharmacist', '+91-9876543217', 'Pharmacy', NOW(), TRUE),
('user-9', 'Lab Technician Ramesh', 'ramesh@phc1.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'participant', 'inst-3', 'Lab Technician', '+91-9876543218', 'Laboratory', NOW(), TRUE),
('user-10', 'Dr. Lakshmi Iyer', 'lakshmi@hospital1.gov', '$2b$10$dICwnjCv9tj6RbnnbA3CpOMViALtjGbb5thxSmHnarPJPJmXVLcZy', 'participant', 'inst-1', 'Senior Medical Officer', '+91-9876543219', 'Pediatrics', NOW(), TRUE);
